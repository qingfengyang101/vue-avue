...
<script>
  import {fetchList, createProductCate, updateProductCate, getProductCate} from '@/api/business/productCate';
  // import {getProductCateList} from '@/api/business/goodslists';
  // import {getProductAttrInfo} from '@/api/business/productAttr';
