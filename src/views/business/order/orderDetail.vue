    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <!-- <el-col :span="4" class="table-cell">APP</el-col>
        ...
        <!-- <el-row>
          ...
          <el-col :span="4" class="table-cell-title">订单可得U币</el-col>
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="12" class="table-cell"><p>{{order | formatAddress}}</p></el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
...
<script>
  import {getOrderDetail,updateReceiverInfo,updateMoneyInfo,closeOrder,updateOrderNote,deleteOrder} from '@/api/business/order.js';
